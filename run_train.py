...
parser.add_argument('--lr-scheduler', type=str, default='no', choices=['no', 'step', 'plateau'])
parser.add_argument('--lr-step', type=int, default=4, help='LR scheduler step size (epochs)')
